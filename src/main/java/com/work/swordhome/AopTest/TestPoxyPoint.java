...
public class TestPoxyPoint {
    ...
    @Before("com.qunar.business.sword.AopTest.TestPointCut.pointCut01()")
    public void testB(){
        System.out.println("this is point before!");
    }

    @After("com.qunar.business.sword.AopTest.TestPointCut.pointCut01()")
    public void testA(){
        System.out.println("this is point after!");
    }

    @Around("com.qunar.business.sword.AopTest.TestPointCut.pointCut01()")
    ...
    @AfterReturning("com.qunar.business.sword.AopTest.TestPointCut.pointCut01() && args(name)")
